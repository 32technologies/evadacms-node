...
class Evada {
  ...
  getContentItem (params) {
    let url = `${this.baseUrl}/${this.containerId}/content-items/${params.contentTypeSlug}/${params.contentItemSlug}?`
    if (params) {
      if (params.contentTypeSlug === undefined) {
        throw new Error('A content types slug was not specified.')
      }
