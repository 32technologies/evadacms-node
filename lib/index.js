...
class Evada {
  ...
  getPermissions () {
    return axios.get(
      `${this.baseUrl}/${this.containerId}/permissions`,
      { headers: { Authorization: `Bearer ${this.token}` } }
  ...
  getPermissionsByUser (id) {
    return axios.get(
      `${this.baseUrl}/${this.containerId}/permissions/${id}`,
      { headers: { Authorization: `Bearer ${this.token}` } }
    ).then(response => response.data.permissions)
  }

  updatePermissionsByUser (id, permissions) {
    return axios.put(
      `${this.baseUrl}/${this.containerId}/permissions/${id}`, permissions,
      { headers: { Authorization: `Bearer ${this.token}` } }
    ).then(response => response.data.permissions)
  }
  ...
  addPermissions (permissions) {
    return axios.post(
      `${this.baseUrl}/${this.containerId}/permissions`, permissions,
      { headers: { Authorization: `Bearer ${this.token}` } }
    ).then(response => response.data.permissions)
  }
  ...
  removePermissions (value) {
    return axios.delete(
      `${this.baseUrl}/${this.containerId}/permissions/${value.id}?invite=${value.invited}`,
      value.permissions,
      { headers: { Authorization: `Bearer ${this.token}` } }
    ).then(response => response.data.permissions)
  }
